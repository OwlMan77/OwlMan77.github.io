...
github: https://github.com/OwlMan77/WDI_PROJECT_3
---
The main concept of this project was to create an app that would allow people to create anonymous feed to a organisation or group.This was a full MEAN stack app with Chart.js and JWT token authentication with a ui-state based view system.

My main responsibilities to this project were to implement JWT authentication, an anonymised name factory for idea authors and several CSS features.
